...
MaxIt=1300;      % Maximum Number of Iterations
...
for it=1:MaxIt
    ...
    percentage=eval_clust2(BestSol.Out.ind,2);
    % Show Iteration Information
     disp(['Iteration ' num2str(it) ': Best Cost = ' num2str(BestCost(it)) ': percentage = ' num2str(percentage) ]);
